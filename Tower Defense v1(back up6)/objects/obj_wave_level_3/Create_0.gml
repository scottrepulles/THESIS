/// @description Wave Manager  Level 8-10
...
array_push(wave_array, new WaveData(
	[obj_monster_1, obj_monster_1, obj_monster_1, obj_monster_3, obj_monster_3, obj_monster_3, 
	 obj_monster_4, obj_monster_4, obj_monster_4, obj_monster_4, obj_monster_1, obj_monster_1,
	 obj_monster_3, obj_monster_3, obj_monster_3, obj_monster_3],
	(room_speed * 3)
));
...
array_push(wave_array, new WaveData(
	...
	obj_monster_1, obj_monster_4, obj_monster_4,	obj_monster_3, obj_monster_4,
	obj_monster_1, obj_monster_boss, obj_monster_boss, obj_monster_boss_2,],
	(room_speed * 1.75)
));
...
array_push(wave_array, new WaveData(
	...
	obj_monster_boss,obj_monster_boss_2,obj_monster_grand_boss ],
	(room_speed  * 1.55)
));
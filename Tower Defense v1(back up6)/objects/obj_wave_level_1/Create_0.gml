/// @description Wave Manager  Level 1-3
...
array_push(wave_array, new WaveData(
	[obj_monster_1,obj_monster_1,obj_monster_1, obj_monster_1, obj_monster_3,
	obj_monster_3, obj_monster_3, obj_monster_4, obj_monster_4,obj_monster_4, obj_monster_4 ],
	(room_speed * 3)
));
...
array_push(wave_array, new WaveData(
	...
	obj_monster_3, obj_monster_4,obj_monster_4,obj_monster_3,obj_monster_1,obj_monster_1,
...
array_push(wave_array, new WaveData(
	...
	obj_monster_4, obj_monster_3, obj_monster_3,	obj_monster_1, obj_monster_boss_2],
	(room_speed  * 1.55)
));
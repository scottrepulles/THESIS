/// obj_button_shop - Draw Event (Enhanced - replace previous)
...
if (glow_alpha > 0.01) {
    ...
    for (var i = 3; i > 0; i--) {
        ...
        // Alternate between blue shades for depth
        var _color = (i % 2 == 0) ? neon_blue : neon_cyan;
        
        draw_sprite_ext(sprite_index, 0, x, y, 
            _glow_scale, _glow_scale, 0, 
            _color, _glow_a);
    }
...
if (hover) {
    ...
    draw_sprite_ext(sprite_index, 0, x, y, 
        1, 1, 0, neon_blue, (glow_alpha * 0.3) + (_pulse * 0.2));
    gpu_set_blendmode(bm_normal);
}

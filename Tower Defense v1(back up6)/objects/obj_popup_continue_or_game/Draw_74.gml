/// @description continue or lesson
...
draw_text_transformed_outlined(x, y - map_value(image_xscale, 0, 1, 0, 280), " CONTNUE TO LESSON?", image_xscale, image_yscale, image_angle, #baaa7d, #33261E);

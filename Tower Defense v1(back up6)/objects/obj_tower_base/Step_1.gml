// Room Start event
if (!variable_global_exists("popup_menu_exists")) {
    global.popup_menu_exists = false;
}
if (!variable_global_exists("menu_lock")) {
    global.menu_lock = false;
}
/// @description Tower Base

// If a popup menu exists, exit
if (variable_global_exists("popup_menu_exists") && global.popup_menu_exists) 
{
    exit;
}

// Check if the menu is locked
if (variable_global_exists("menu_lock") && global.menu_lock)
{
...
// If the menu isn't locked, and the mouse isn't hovering over this instance
else 
{

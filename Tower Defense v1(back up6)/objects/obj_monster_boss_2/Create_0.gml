...
v_speed = my_speed * 0.5;

// This variable holds the sprite to use when the enemy is moving sideways
walk_side_sprite = spr_walk_monster_boss_2;
walk_up_sprite = spr_walk_monster_boss_2;
walk_down_sprite = spr_walk_monster_boss_2;

// The defeated enemy to spawn if the enemy is moving sideways
defeat_side_object = obj_defeat_monster_boss_2;

// The defeated enemy to spawn if the enemy is moving down
defeat_down_object = obj_defeat_monster_boss_2;

...
walk_side_sprite = spr_walk_grand_boss;
walk_up_sprite = spr_walk_grand_boss;
walk_down_sprite = spr_walk_grand_boss;

// The defeated enemy to spawn if the enemy is moving sideways
defeat_side_object = obj_defeat_grand_boss;

// The defeated enemy to spawn if the enemy is moving down
defeat_down_object = obj_defeat_grand_boss;
